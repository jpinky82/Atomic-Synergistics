...
namespace AS.UI.MVC.Controllers
{
    ...
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(ASContext context)
        {
            _context = context;
        }
        ...
        {
            var aSContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ASContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
