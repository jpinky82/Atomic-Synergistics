...
namespace AS.UI.MVC.Controllers
{
    ...
    public class ProductStatusController : Controller
    {
        ...
        public ProductStatusController(ASContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductStatuses != null ? 
                          ...
                          Problem("Entity set 'ASContext.ProductStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ASContext.ProductStatuses'  is null.");
            }
            var productStatus = await _context.ProductStatuses.FindAsync(id);
            if (productStatus != null)
            {
